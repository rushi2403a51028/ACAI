...
def main():
    print("Welcome to the Product Recommendation System! - task_3.py:24")
    print("Type your search (e.g., soap, mobile, toys, games). Type 'exit' to finish. - task_3.py:25")
    while True:
    ...
    print("Based on your search history, we recommend: - task_3.py:34")
    print(", - task_3.py:35".join(final_recs))
